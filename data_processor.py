...
class DataProcessor:
    ...
    def process(self, input_player: str, player_year=2025):
        ...
        self.knn_metrics = [m for m in valid_metrics if m not in exclusions]
        ...
        distances, indices = knn.kneighbors(self.percentile_df.loc[input_index, self.knn_metrics].values.reshape(1, -1))
        ...
        self.radar_data = [self.percentile_df[self.percentile_df["player"] == p][valid_metrics].iloc[0].values for p in self.comparison_players]
